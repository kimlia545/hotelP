...
<input type="hidden" value="<%=hotelmainimg.get(0).getRoomnum()%>" id="roomnumberidx">
...
<div style="border: 1px solid black; padding: 15px; width: 1150px; margin: 0 auto;" >
	<div style="display: flex" class ="topbar">
		<div style="width: 503px; border: 1px solid black;">
			<div><img style="width: 498px" src="<%=StaticValue.saveFolder%>/<%=hotelmainimg.get(0).getHotelfilname()%>"></div>
			
		</div>
		<div>
			<div style="width:300; margin-right: 10px; margin-left: 10px; ">
				<div style="border-bottom: 1px solid black;"><%=hotelmainimg.get(0).getHotelname()%></div>
			<br><img src="hotelimg/star_gray.png">
			 	<img src="hotelimg/star_gray.png">
			 	<img src="hotelimg/star_gray.png">
			 	<img src="hotelimg/star_gray.png">
			 	<img src="hotelimg/star_gray.png">
			 	 <br><br>
			 	<div style="border-bottom: 1px solid black;"><%=hotelmainimg.get(0).getHoteladdress()%></div>
			 	
			 </div>
		</div>
		<br>
		<div style="width: 350px">객실 수
			<div><%=hotelmainimg.get(0).getRoomnum()%></div>
...
<div class="room_info">
	<%for(int i=0; i<hotelmainimg.get(0).getRoomnum(); i++){ %>
	<table style="border: 1px solid black; width: 1105px; padding: 5px; border-collapse: collapse;">		
			<tr>
				...
				<td><div style="font-weight: bold; height: 30px; width: 150px"><%=hotelroomimg.get(i).getRoomType() %></div>
				<td>
					<div style="display: flex;">
						<div style="width: 120px">최소 투숙객 <%=hotelroomimg.get(i).getMinGuest()%>명</div> ~&nbsp; <div style="width: 150px">최대 투숙객 <%=hotelroomimg.get(i).getMaxGuest()%>명</div>
					</div>
				</td>	
			</tr>
			...
			<tr style="margin-left: 20px;">
				...
				<td><label><%=hotelroomimg.get(i).getRoomprice() %> 원</label></td>
			</tr>
			
			<tr>
				<td colspan="1"><div style="width: 150px">방 갯수 <%=hotelroomimg.get(i).getRoomAmount()%></div></td>
			</tr>
...
<form action="Ceoroomcomlete.do">
	<input type="submit" value="확 인ㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇ">
</form>
...
<script type="text/javascript">
	$(function(){
	/* 		var roomsumidx =$("#roomnumberidx").val(); 
			$("#rooms").empty();
			for(var i=1;i<=roomsumidx;i++){ 			
				var txt ="<br>"
					txt +="<table style='border: 1px solid black; width: 1105px; padding: 5px; border-collapse: collapse;'>";		
					txt +="<tr>";
