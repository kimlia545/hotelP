...
<form id="review" name="review" action="reviewPageproc.do" method="post"> 
		...
		<div class="review">
			...
			<div class="riview2">
				내용 &nbsp;&nbsp;&nbsp;&nbsp;
				<input type="content" id="content" name="content" value="호텔에 대한 솔직한 리뷰를 남겨주세요.">
			</div><br>
			<div class="grade">
          		 <div class="grade1">
          		 	평점 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          		 ...
          		 <div class="stars">
					 <img src="hotelimg/star_gray.png" class="star">
					 <img src="hotelimg/star_gray.png" class="star">
					 <img src="hotelimg/star_gray.png" class="star">
					 <img src="hotelimg/star_gray.png" class="star">
					 <img src="hotelimg/star_gray.png" class="star">
			...
			<div class="button">
				<input type="button" value="취소" id="cancle" onclick="closeThis()">
				<input type="hidden" name="grade" class="starvalue" id="grade">
